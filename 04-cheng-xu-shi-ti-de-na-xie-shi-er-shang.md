...
{% file src=".gitbook/assets/4.程序实体的那些事儿（上）.mp3" %}
...
> 简单地说，类型推断是一种编程语言在编译期自动解释表达式类型的能力。什么是表达式？详细的解释你可以参看 Go 语言规范中的[表达式](https://golang.google.cn/ref/spec#Expressions)和[表达式语句](https://golang.google.cn/ref/spec#Expression\_statements)章节。我在这里就不赘述了。
